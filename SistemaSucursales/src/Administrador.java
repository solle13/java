...
public class Administrador extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NorteG.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        NorteG.setText("Norte");
        jPanel1.add(NorteG);
        NorteG.setBounds(260, 170, 55, 25);

        buttonGroup2.add(CentroG);
        CentroG.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        ...
        NorteM.setFont(new java.awt.Font("Calibri", 0, 12)); // NOI18N
        ...
        PanelGrafico.setBounds(359, 38, 260, 300);
        ...
        jButton2.setBounds(91, 215, 79, 25);
...
private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
    ...
    if(x.equals("")){
        JOptionPane.showMessageDialog(null,"La direccion no debe de estar vacia","",JOptionPane.WARNING_MESSAGE);
        }
    else{    
